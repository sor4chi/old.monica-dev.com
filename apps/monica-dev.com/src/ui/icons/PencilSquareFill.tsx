...
const SvgPencilSquareFill = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="pencil-square-fill_svg__w-6 pencil-square-fill_svg__h-6"
    viewBox="0 0 24 24"
    {...props}
  >
...
export default SvgPencilSquareFill;
